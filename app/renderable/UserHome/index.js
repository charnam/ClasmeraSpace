...
class UserHome extends Overlay {
	...
	render() {
		...
		homeScreen.append(
			header = new HTML.div({class: "base-header home-header"},
				userButton = new HTML.div({class: "home-header-user base-pillbutton"},
					userName = new HTML.div({class: "home-header-user-name"}, "Loading...")
				),
				timeDisplay = new HTML.div({class: "home-header-time base-pillbutton"}),
			),
